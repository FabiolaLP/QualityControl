...
Quality FV0Check::check(std::map<std::string, std::shared_ptr<MonitorObject>>* moMap)
{
  // THUS FUNCTION BODY IS AN EXAMPLE. PLEASE REMOVE EVERYTHING YOU DO NOT NEED.
  ...
  // This is an example of accessing the histogram 'example' created by MyModuleTask
...
std::string FV0Check::getAcceptedType()
{
  // This method is a remnant of early interface prototype and will be removed in the scope of ticket QC-373
  return "TH1";
}

void FV0Check::beautify(std::shared_ptr<MonitorObject> mo, Quality checkResult)
{
  // THUS FUNCTION BODY IS AN EXAMPLE. PLEASE REMOVE EVERYTHING YOU DO NOT NEED.
...
{
  // THUS FUNCTION BODY IS AN EXAMPLE. PLEASE REMOVE EVERYTHING YOU DO NOT NEED.
  ILOG(Debug, Devel) << "FV0Check::reset" << ENDM;
  // please reset the state of the check here to allow for reuse between consecutive runs.
}

void FV0Check::startOfActivity(const Activity& activity)
{
  // THUS FUNCTION BODY IS AN EXAMPLE. PLEASE REMOVE EVERYTHING YOU DO NOT NEED.
  ILOG(Debug, Devel) << "FV0Check::start : " << activity.mId << ENDM;
  mActivity = make_shared<Activity>(activity);
}

void FV0Check::endOfActivity(const Activity& activity)
{
  // THUS FUNCTION BODY IS AN EXAMPLE. PLEASE REMOVE EVERYTHING YOU DO NOT NEED.
  ILOG(Debug, Devel) << "FV0Check::end : " << activity.mId << ENDM;
}
